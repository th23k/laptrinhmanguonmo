...
<div class="wp-block-query"><!-- wp:post-template {"style":{"typography":{"fontSize":"14px"}},"textColor":"black","className":"products-block-post-template","layout":{"type":"grid","columnCount":4},"__woocommerceNamespace":"woocommerce/product-query/product-template"} -->
...
<!-- wp:woocommerce/product-button {"textAlign":"center","isDescendentOfQueryLoop":true,"textColor":"base","style":{"elements":{"link":{"color":{"text":"var:preset|color|Theme"},":hover":{"color":{"text":"var:preset|color|white"}}}},"typography":{"fontSize":"14px","lineHeight":"2"}}} /-->
